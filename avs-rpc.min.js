...
"application/json");b.onload(function(a){return function(){return a.process(b.response)}}(this));return b.send(d)})}k(a,c);return a}(n);q.ioRpc=function(c){function a(a,c){this.socket=a;this.tag=null!=c?c:"rpc";this.locals=[];if(this.socket)this.socket.on(this.tag,function(a){return function(b,c){return a.process(b,c)}}(this))}k(a,c);a.prototype._request=function(a){var c,d;console.log("rpc "+a.id+": out "+this.tag+" "+(d=l.stringify(a)));c=a.cb||function(){};if(this.socket)return this.socket.emit(this.tag,
d,function(){return c.apply(this,arguments)})};a.prototype.process=function(a,c){var d,e,g;g=l.parse(a);this.log("rpc "+g.id+": in  "+this.tag+" "+a);if(e=this.locals[g.method])try{return d=g.args||[],d.push(function(a){return function(){return c.apply(a,arguments)}}(this)),e.asynchronous?e[g.method](g.id,d):c(e[g.method](g.id,d))}catch(h){return c(null,"error in "+g.method+": "+h)}else return c(null,"error: method "+g.method+" is unknown")};return a}(n)}).call(this)},{"circular-json":1}]},{},[2])(2)});
