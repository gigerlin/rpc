...
h(a,c);return a}(n);q.ioRpc=function(c){function a(a,c){this.socket=a;this.tag=null!=c?c:"rpc";this.locals=[];if(this.socket)this.socket.on(this.tag,function(a){return function(b,c){return a.process(b,c)}}(this))}h(a,c);a.prototype._request=function(a){var c;this.log("rpc "+a.id+": out "+this.tag+" "+(c=l.stringify(a)));if(this.socket)return this.socket.emit(this.tag,c,function(){if(a.cb)return a.cb.apply(this,arguments)})};a.prototype.process=function(a,c){var e,d,f;f=l.parse(a);this.log("rpc "+
f.id+": in  "+this.tag+" "+a);if(d=this.locals[f.method])try{return e=f.args||[],e.push(function(a){return function(){return c.apply(a,arguments)}}(this)),d.asynchronous?d[f.method](f.id,e):c(d[f.method](f.id,e))}catch(g){return this.log(e="error in "+f.method+": "+g),c(null,e)}else return this.log(e="error: method "+f.method+" is unknown"),c(null,e)};return a}(n)}).call(this)},{"circular-json":1}]},{},[2])(2)});
